# What is a variable: Vairables are labels which act as containers to hold values. In python a variable is always associated with some values.
...
# variable names cannot contain spaces. We can use the underscore to separate the names.

total_marks = 85
print(total_marks)

# variable names are not supposed to be keywords/reserved characters in python e.g for
